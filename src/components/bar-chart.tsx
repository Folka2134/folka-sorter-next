...
export function BarChart({ data, maxValue, isPlaying, highlightIndices = [], theme }: BarChartProps) {
  ...
  return <canvas ref={canvasRef} width={150} height={100} className="w-full h-full" />
}
